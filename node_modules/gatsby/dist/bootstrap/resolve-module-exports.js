...
const staticallyAnalyzeExports = (modulePath, resolver = require.resolve) => {
  ...
  (0, _traverse.default)(ast, {
    ...
    ExportNamedDeclaration: function ExportNamedDeclaration(astPath) {
      ...
      if ((0, _get.default)(astPath, `node.declaration.type`) === `VariableDeclaration` && (0, _get.default)(astPath, `node.declaration.declarations[0].id.name`)) {
        isES6 = true;
        exportNames.push(declaration.declarations[0].id.name);
      } // get foo from `export function foo()`


      if ((0, _get.default)(astPath, `node.declaration.type`) === `FunctionDeclaration` && (0, _get.default)(astPath, `node.declaration.id.name`)) {
        isES6 = true;
